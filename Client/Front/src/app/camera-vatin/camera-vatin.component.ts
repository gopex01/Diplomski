...
@Component({
  selector: 'app-camera-vatin',
  templateUrl: './camera-vatin.component.html',
  styleUrls: ['./camera-vatin.component.css']
})
export class CameraVatinComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Vatin/vatin1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Vatin/vatin2.m3u8';
