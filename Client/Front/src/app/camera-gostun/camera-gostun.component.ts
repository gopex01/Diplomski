...
@Component({
  selector: 'app-camera-gostun',
  templateUrl: './camera-gostun.component.html',
  styleUrls: ['./camera-gostun.component.css']
})
export class CameraGostunComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Gostun/gostun1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Gostun/gostun2.m3u8';
