...
@Component({
  selector: 'app-camera-zvornik',
  templateUrl: './camera-zvornik.component.html',
  styleUrls: ['./camera-zvornik.component.css']
})
export class CameraZvornikComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/MaliZvornik/malizvornik1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/MaliZvornik/malizvornik2.m3u8';
