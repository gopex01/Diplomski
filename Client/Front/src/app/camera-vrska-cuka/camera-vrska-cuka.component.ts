...
@Component({
  selector: 'app-camera-vrska-cuka',
  templateUrl: './camera-vrska-cuka.component.html',
  styleUrls: ['./camera-vrska-cuka.component.css']
})
export class CameraVrskaCukaComponent implements AfterViewInit {
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/VrskaCuka/vrskacuka1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/VrskaCuka/vrskacuka2.m3u8';
