...
@Component({
  selector: 'app-camera-gradina',
  templateUrl: './camera-gradina.component.html',
  styleUrls: ['./camera-gradina.component.css']
})
export class CameraGradinaComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Gradina/gradina1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Gradina/gradina2.m3u8';
