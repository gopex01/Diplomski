...
@Component({
  selector: 'app-camera-presevo',
  templateUrl: './camera-presevo.component.html',
  styleUrls: ['./camera-presevo.component.css']
})
export class CameraPresevoComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Horgos/horgos1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Horgos/horgos2.m3u8';
