...
@Component({
  selector: 'app-camera-trbusnica',
  templateUrl: './camera-trbusnica.component.html',
  styleUrls: ['./camera-trbusnica.component.css']
})
export class CameraTrbusnicaComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Trbusnica/trbusnica1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Trbusnica/trbusnica2.m3u8';
