...
@Component({
  selector: 'app-camera-sid',
  templateUrl: './camera-sid.component.html',
  styleUrls: ['./camera-sid.component.css']
})
export class CameraSidComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Djala/djala1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Djala/djala2.m3u8';
