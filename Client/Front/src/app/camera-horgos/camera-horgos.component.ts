...
@Component({
  selector: 'app-camera-horgos',
  templateUrl: './camera-horgos.component.html',
  styleUrls: ['./camera-horgos.component.css']
})
export class CameraHorgosComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Presevo/presevo1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Presevo/presevo2.m3u8';
