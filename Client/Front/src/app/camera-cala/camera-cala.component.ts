// camera-cala.component.ts
import { AfterViewInit, Component, ViewChild, ElementRef } from '@angular/core';
import Hls from 'hls.js';

@Component({
  selector: 'app-camera-cala',
  templateUrl: './camera-cala.component.html',
  styleUrls: ['./camera-cala.component.css']
})
export class CameraCalaComponent implements AfterViewInit {
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Sid/sid1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Sid/sid2.m3u8';
