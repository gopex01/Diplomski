...
@Component({
  selector: 'app-camera-kelebija',
  templateUrl: './camera-kelebija.component.html',
  styleUrls: ['./camera-kelebija.component.css']
})
export class CameraKelebijaComponent implements AfterViewInit{
  ...
  videoUrl1:string='http://77.46.142.211:8081/Kelebija/kelebija1.m3u8';
  videoUrl2:string='http://77.46.142.211:8081/Kelebija/kelebija2.m3u8';
