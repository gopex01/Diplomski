...
@Component({
  selector: 'app-camera-jabuka',
  templateUrl: './camera-jabuka.component.html',
  styleUrls: ['./camera-jabuka.component.css']
})
export class CameraJabukaComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Jabuka/jabuka1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Jabuka/jabuka2.m3u8';
