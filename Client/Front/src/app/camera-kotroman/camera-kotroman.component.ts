...
@Component({
  selector: 'app-camera-kotroman',
  templateUrl: './camera-kotroman.component.html',
  styleUrls: ['./camera-kotroman.component.css']
})
export class CameraKotromanComponent implements AfterViewInit{
  ...
  videoUrl1: string = 'http://77.46.142.211:8081/Kotroman/kotroman1.m3u8';
  videoUrl2: string = 'http://77.46.142.211:8081/Kotroman/kotroman2.m3u8';
